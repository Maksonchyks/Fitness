...
namespace FitnessApp.Workout.Infrastructure.Persistence.Configurations
{
    public class TrainingProgramConfiguration : IEntityTypeConfiguration<TrainingProgram>
    {
        public void Configure(EntityTypeBuilder<TrainingProgram> builder)
        {
            ...
            builder
                .OwnsOne(p => p.ProgramProfile, navigationBuilder =>
                {
                    navigationBuilder
                        .Property(pp => pp.Goal)
                        .HasColumnName("Goal")
                    ...
                    navigationBuilder
                        .Property(pp => pp.Intensity)
                        .HasColumnName("Intensity")
                        .HasConversion<int>()
                        .IsRequired();

                    navigationBuilder
                        .OwnsOne(pp => pp.PowerMetrics, metricsBuilder =>
                        {
                            
                            metricsBuilder
                                .Property(pm => pm.SquatWeight)
                                .HasColumnName("PowerMetrics_SquatWeight")
                                .HasPrecision(5, 2) 
                                .IsRequired(false);

                            metricsBuilder
                                .Property(pm => pm.BenchPressWeight)
                                .HasColumnName("PowerMetrics_BenchPressWeight")
                                .HasPrecision(5, 2)
                                .IsRequired(false);

                            metricsBuilder
                                .Property(pm => pm.DeadliftWeight)
